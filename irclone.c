...
int RECV_PIN = 4; //PINO DIGITAL EM QUE O FOTORRECEPTOR ESTÁ CONECTADO - GPIO04 / PINO D4
...
void dump(decode_results *results) {
  ...
  //Infelizmente Panasonic esta com problemas
  ...
  */
  ...
  //Infelizmente AIWA esta com problemas
